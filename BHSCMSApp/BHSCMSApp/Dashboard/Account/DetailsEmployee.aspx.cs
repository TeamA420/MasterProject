    ...
    public partial class DetailsEmployee : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            try
            {
                ...
                string cmd = String.Format("Select E.EmpID, E.LastName, E.FirstName, R.Name, U.UserID, U.UserName, U.Password, U.PrimaryEmail, U.SecondaryEmail from BHSCMS.dbo.EmployeeTable E join BHSCMS.dbo.SysUserTable U on e.UserID=u.UserID join BHSCMS.dbo.RoleTable R on E.RoleID=u.RoleID Where U.UserID={0}", _userID);
