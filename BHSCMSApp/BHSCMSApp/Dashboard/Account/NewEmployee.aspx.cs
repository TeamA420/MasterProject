...
namespace BHSCMSApp.Dashboard.Register
{
    ...
    public partial class NewEmployee : System.Web.UI.Page
    {
        ...
        {
            if(EmpIDValidate.IsValid && FirstNameValidate.IsValid && LastNameValidate.IsValid && passwordValidate.IsValid && PriEmailValidate.IsValid && RoleValidate.IsValid && SecEmailValidate.IsValid )
            {
