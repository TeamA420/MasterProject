    ...
    public partial class ManageVendors : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            try
            {
                ...
                string cmd = "Select U.UserID, U.UserName, V.CompanyName, V.State, V.Status from BHSCMS.dbo.SysUserTable U join BHSCMS.dbo.VendorTable V on U.UserID=V.UserID Where U.RoleID=3";
