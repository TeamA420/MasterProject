    ...
    public partial class DetailsVendor : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            try
            {
                ...
                string cmd = String.Format("Select V.VendorID, V.CompanyName, V.PhoneNumber, V.FaxNumber, V.AddressLine1, V.AddressLine2, V.City, V.State, V.ZipCode, V.BillingAddress1, v.BillingAddress2, v.BillingCity, v.BillingState, v.BillingZipcode, v.Status, v.TaxID, v.RegistrationDate, U.UserID, u.UserName, u.Password, u.PrimaryEmail, u.SecondaryEmail, r.Name from BHSCMS.dbo.SysUserTable U inner join BHSCMS.dbo.VendorTable V on U.UserID=V.UserID inner join BHSCMS.dbo.RoleTable R on u.RoleID=r.RoleID Where V.UserID={0}", _userID);
