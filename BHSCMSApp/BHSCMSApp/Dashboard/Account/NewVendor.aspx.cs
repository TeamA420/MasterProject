    ...
    public partial class NewVendor : System.Web.UI.Page
    {
        ...
        protected void addButton_Click(object sender, EventArgs e)
        {
            if (ValidVend.IsValid == true && ValidTaxID.IsValid == true)
            {
                ...
                vend.RegisterVendor(company, userid, phone, fax, address1, address2, city, state, zipcode, status, registrationDate, taxid);//registers the vendor in the VendorTable
