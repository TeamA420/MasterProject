        ...
        {           
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string updateQry = "update SysUserTable set UserName=@username, Password=@password, PrimaryEmail=@primaryemail, SecondaryEmail=@secondaryemail, RoleID=@roleID where UserID=@userid";
